...
- Capture Timeline and `photo_timeline` use only `date_taken`; files without capture dates are excluded rather than falling back to modified or folder dates.
