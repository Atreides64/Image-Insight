...
- Keep the scan, search, and history components in the dashboard, but expose them through lightweight Tools cards so the main page reads as Header, Insights, then Tools.
